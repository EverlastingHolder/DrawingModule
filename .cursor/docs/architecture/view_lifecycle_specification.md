...
*   **DrawingSession (Владелец)**: Центральный объект бизнес-логики. Владеет `TileSystem`, `DrawEngine`, `UndoCoordinator` и настройками кисти. Существует независимо от вьюхи.
